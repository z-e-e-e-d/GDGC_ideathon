...
const OwnerLayout = () => {
  ...
  const navItems = [
    ...
    { icon: Building2, label: "My Stadiums", path: "/owner/stadiums" },
    { icon: Calendar, label: "Timeline", path: "/owner/timeline" },
    { icon: ClipboardList, label: "Requests", path: "/owner/requests" },
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-muted-foreground">Stadium Owner</p>
            </div>
          </div>
        </div>
      </aside>
